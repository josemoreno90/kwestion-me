  ...
  if (ts) {
    for (var i = 0; i < ts.length; i++) {
      if (ts[i]['id'] === t.source) {
        ...
        return (0, _styles.createMuiTheme)(_extends({}, source, { palette: _extends({}, palette, { type: t.isNightModeOn ? 'dark' : 'light' }) }));
      }
    }
  }

  return (0, _styles.createMuiTheme)({ palette: { type: t.isNightModeOn ? 'dark' : 'light' } }); // Default theme
};
