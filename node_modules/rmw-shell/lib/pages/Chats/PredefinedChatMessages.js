...
var PredefinedChatMessages = exports.PredefinedChatMessages = function (_Component) {
  ...
  function PredefinedChatMessages() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = {
      ...
      firebaseApp.database().ref('/' + path + '/').push({ message: _this.state.value }).then(function () {
  ...
  PredefinedChatMessages.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        { style: { overflow: 'auto', height: '100%', width: '100%', backgroundColor: theme.palette.canvasColor, paddingBottom: 56 } },
        _react2.default.createElement(
          _Scrollbar2.default,
          null,
          _react2.default.createElement(
      ...
      list && _react2.default.createElement(
        ...
        { style: { width: '100%', position: 'absolute', bottom: 0, right: 0, left: 0, zIndex: 50, backgroundColor: theme.palette.background.default } },
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              _Icon2.default,
              { className: 'material-icons', color: theme.palette.primary1Color },
              'send'
            )
          )
        )
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, { setSimpleValue: _actions.setSimpleValue })((0, _reactIntl.injectIntl)((0, _styles.withTheme)()((0, _reactRouterDom.withRouter)((0, _firekitProvider.withFirebase)(PredefinedChatMessages)))));