    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.handleRowClick = function (user) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _ListItem2.default,
          {
            ...
            id: key },
          user.photoURL && _react2.default.createElement(_Avatar2.default, { src: user.photoURL, alt: 'person' }),
          !user.photoURL && _react2.default.createElement(
            _Avatar2.default,
            null,
            ' ',
            _react2.default.createElement(
          ...
          _react2.default.createElement(_ListItemText2.default, { primary: user.displayName, secondary: !user.connections && !user.lastOnline ? intl.formatMessage({ id: 'offline' }) : intl.formatMessage({ id: 'online' }) })
        ),
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_ListItem2.default, {
          ...
          leftAvatar: _react2.default.createElement(_Avatar2.default, { style: { marginTop: 10 }, src: user.photoURL, alt: 'person', icon: _react2.default.createElement(
              _Icon2.default,
          ...
          rightIcon: _react2.default.createElement(
            _Icon2.default,
            { style: { marginTop: 22 }, className: 'material-icons', color: user.connections ? theme.palette.primary1Color : theme.palette.disabledColor },
            'offline_pin'
          )
        }),
        _react2.default.createElement(_Divider2.default, { inset: true })
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, _extends({}, _materialUiFilter.filterActions, { setPersistentValue: _actions.setPersistentValue }))((0, _reactIntl.injectIntl)((0, _withWidth2.default)()((0, _styles.withTheme)()((0, _styles.withStyles)(function (theme) {}, { withTheme: true })((0, _firekitProvider.withFirebase)((0, _reactRouterDom.withRouter)(Users)))))));