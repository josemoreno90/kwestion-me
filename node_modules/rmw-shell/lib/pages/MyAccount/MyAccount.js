...
var MyAccount = exports.MyAccount = function (_Component) {
  ...
  function MyAccount() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = {
      ...
      import('firebase').then(function (firebase) {
        ...
        firebaseApp.auth().currentUser.linkWithPopup(provider).then(function (payload) {
      ...
      var _this$props5 = _this.props,
          ...
          setSimpleValue = _this$props5.setSimpleValue;
      ...
      var _this$props6 = _this.props,
          ...
          setDialogIsOpen = _this$props6.setDialogIsOpen;
      ...
      var _this$props7 = _this.props,
          ...
          authError = _this$props7.authError;
      ...
      var _this$props8 = _this.props,
          firebaseApp = _this$props8.firebaseApp,
          auth = _this$props8.auth,
          setSimpleValue = _this$props8.setSimpleValue,
          clearMessaging = _this$props8.clearMessaging;
      ...
      var _this$props9 = _this.props,
          firebaseApp = _this$props9.firebaseApp,
          auth = _this$props9.auth,
          setSimpleValue = _this$props9.setSimpleValue;
  ...
  MyAccount.prototype.componentWillMount = function componentWillMount() {
      ...
      auth.uid && _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { className: (0, _classnames2.default)(classes.margin, classes.textField), error: !!this.state.errors.displayName },
            _react2.default.createElement(
            ...
            , { label: 'Email',
              ...
              endAdornment: _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  auth.emailVerified && _react2.default.createElement(
                    _Icon2.default,
                    { color: 'primary' },
                    'verified_user'
                  ),
          ...
          showPasswords && _react2.default.createElement(
            ...
            _react2.default.createElement(
              _FormControl2.default,
              { className: (0, _classnames2.default)(classes.margin, classes.textField), error: !!this.state.errors.password },
              _react2.default.createElement(
                _InputLabel2.default,
                { htmlFor: 'adornment-password' },
                'Password'
            ...
            _react2.default.createElement(
              _FormControl2.default,
              { className: (0, _classnames2.default)(classes.margin, classes.textField), error: !!this.state.errors.newPassword },
              _react2.default.createElement(
                _InputLabel2.default,
                { htmlFor: 'adornment-password' },
            ...
            _react2.default.createElement(
              _FormControl2.default,
              { className: (0, _classnames2.default)(classes.margin, classes.textField), error: !!this.state.errors.confirmPassword },
              _react2.default.createElement(
                _InputLabel2.default,
                { htmlFor: 'adornment-password' },
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, { setSimpleValue: _actions3.setSimpleValue, change: _reduxForm.change, submit: _reduxForm.submit, setDialogIsOpen: _actions.setDialogIsOpen, setPersistentValue: _actions2.setPersistentValue })((0, _reactIntl.injectIntl)((0, _reactRouterDom.withRouter)((0, _styles.withTheme)()((0, _firekitProvider.withFirebase)((0, _withAppConfigs2.default)((0, _styles.withStyles)(styles, { withTheme: true })(MyAccount)))))));