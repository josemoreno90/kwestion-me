...
var SignIn = exports.SignIn = function (_Component) {
  ...
  SignIn.prototype.render = function render() {
    ...
    var uiConfig = {
      ...
      signInFlow: 'popup',
      callbacks: {
        signInSuccessWithAuthResult: function signInSuccessWithAuthResult(user, credentials, redirect) {
          // initMessaging()
      ...
      credentialHelper: _firebaseui2.default.auth.CredentialHelper.NONE
    };
...
exports.default = (0, _reactIntl.injectIntl)((0, _firekitProvider.withFirebase)((0, _withAppConfigs2.default)(SignIn)));