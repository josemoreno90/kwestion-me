...
var RoleGrants = exports.RoleGrants = function (_Component) {
	...
	RoleGrants.prototype.componentWillMount = function componentWillMount() {
	...
	RoleGrants.prototype.render = function render() {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(_materialUiFilter.FilterDrawer, {
				name: 'role_grants',
				fields: filterFields,
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, _extends({ setSimpleValue: _actions.setSimpleValue }, _materialUiFilter.filterActions))((0, _reactIntl.injectIntl)((0, _reactRouterDom.withRouter)((0, _firekitProvider.withFirebase)((0, _withAppConfigs2.default)((0, _styles.withTheme)()(RoleGrants))))));