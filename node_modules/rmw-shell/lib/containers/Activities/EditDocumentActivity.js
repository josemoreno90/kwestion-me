...
var EditDocumentActivity = function (_Component) {
  ...
  function EditDocumentActivity() {
    ...
    }(), _this.hanldeSubmitSuccess = function (values, key) {
...
exports.default = (0, _redux.compose)((0, _reactRedux.connect)(mapStateToProps, { setSimpleValue: _actions.setSimpleValue, change: _reduxForm.change, submit: _reduxForm.submit }), _reactIntl.injectIntl, _reactRouterDom.withRouter, _firekitProvider.withFirebase, (0, _styles.withTheme)())(EditDocumentActivity);
