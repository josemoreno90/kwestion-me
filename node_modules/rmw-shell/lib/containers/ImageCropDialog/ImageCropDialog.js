    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { onClick: function onClick() {
              _this2.handlePhotoURLUpload(_this2.cropper.crop());
            }, color: 'primary', disabled: !this.state.src || this.state.isLoading || this.state.isUploading },
          intl.formatMessage({ id: 'submit' })
        ),
        _react2.default.createElement(
          _Button2.default,
          { onClick: this.handleClose, color: 'secondary', autoFocus: true },
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)((0, _reactIntl.injectIntl)((0, _firekitProvider.withFirebase)((0, _withMobileDialog2.default)()(ImageCropDialog))));