...
var getAppRoutes = function getAppRoutes(firebaseLoader) {
  ...
  var AsyncPredefinedChatMessages = MyLoadable({ loader: function loader() {
      return import('../../pages/Chats/PredefinedChatMessages');
    } });
  ...
  return [React.createElement(RestrictedRoute, { type: 'public', path: '/signin', component: AsyncSignIn }), React.createElement(RestrictedRoute, { type: 'private', path: '/users', exact: true, component: AsyncUsers }), React.createElement(RestrictedRoute, { type: 'private', path: '/users/:select', exact: true, component: AsyncUsers }), React.createElement(RestrictedRoute, { type: 'private', path: '/users/edit/:uid/:editType', exact: true, component: AsyncUser }), React.createElement(RestrictedRoute, { type: 'private', path: '/users/edit/:uid/:editType/:rootPath/:rootUid', exact: true, component: AsyncUser }), React.createElement(RestrictedRoute, { type: 'private', path: '/my_account', exact: true, component: AsyncMyAccount }), React.createElement(RestrictedRoute, { type: 'private', path: '/roles', exact: true, component: AsyncRoles }), React.createElement(RestrictedRoute, { type: 'private', path: '/roles/edit/:uid/:editType', exact: true, component: AsyncRole }), React.createElement(RestrictedRoute, { type: 'private', path: '/predefined_chat_messages', exact: true, component: AsyncPredefinedChatMessages }), React.createElement(RestrictedRoute, { type: 'private', path: '/public_chats', exact: true, component: AsyncPublicChats }), React.createElement(RestrictedRoute, { type: 'private', path: '/chats', exact: true, component: AsyncChats }), React.createElement(RestrictedRoute, { type: 'private', path: '/chats/create', exact: true, component: AsyncCreateChat }), React.createElement(RestrictedRoute, { type: 'private', path: '/chats/edit/:uid', exact: true, component: AsyncChatsEdit }), React.createElement(Route, { component: AsyncPageNotFound })];
};
