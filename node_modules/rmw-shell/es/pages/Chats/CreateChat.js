      ...
      return React.createElement(
        ...
        React.createElement(
          ListItem,
          {
            ...
            id: key },
          user.photoURL && React.createElement(Avatar, { src: user.photoURL, alt: 'person' }),
          !user.photoURL && React.createElement(
            Avatar,
            null,
            ' ',
            React.createElement(
          ...
          React.createElement(ListItemText, { primary: user.displayName, secondary: !user.connections && !user.lastOnline ? intl.formatMessage({ id: 'offline' }) : intl.formatMessage({ id: 'online' }) })
        ),
...
export default connect(mapStateToProps, _extends({}, filterActions, { setPersistentValue: setPersistentValue }))(injectIntl(withWidth()(withTheme()(withStyles(function (theme) {}, { withTheme: true })(withFirebase(withRouter(Users)))))));