    ...
    return React.createElement(
      ...
      auth.uid && React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            FormControl,
            { className: classNames(classes.margin, classes.textField), error: !!this.state.errors.displayName },
            React.createElement(
              InputLabel,
            ...
            , { label: 'Email',
              ...
              endAdornment: React.createElement(
                ...
                React.createElement(
                  ...
                  auth.emailVerified && React.createElement(
                    Icon,
                    { color: 'primary' },
                    'verified_user'
                  ),
          ...
          showPasswords && React.createElement(
            ...
            React.createElement(
              FormControl,
              { className: classNames(classes.margin, classes.textField), error: !!this.state.errors.password },
              React.createElement(
                InputLabel,
                { htmlFor: 'adornment-password' },
                'Password'
            ...
            React.createElement(
              FormControl,
              { className: classNames(classes.margin, classes.textField), error: !!this.state.errors.newPassword },
              React.createElement(
                InputLabel,
                { htmlFor: 'adornment-password' },
            ...
            React.createElement(
              FormControl,
              { className: classNames(classes.margin, classes.textField), error: !!this.state.errors.confirmPassword },
              React.createElement(
                InputLabel,
                { htmlFor: 'adornment-password' },
