        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(Tab, { value: 'main', icon: React.createElement(
                  Icon,
                  { className: 'material-icons' },
                  'account_box'
                ) }),
              React.createElement(Tab, { value: 'grants', icon: React.createElement(
                  Icon,
                  { className: 'material-icons' },
                  'lock'
                ) })
          ...
          editType === 'main' && React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                FormControl,
                { className: classNames(classes.margin, classes.textField), error: !!this.state.errors.name },
                React.createElement(
                  InputLabel,
